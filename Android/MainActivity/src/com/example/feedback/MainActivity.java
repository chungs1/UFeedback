...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private class TestPost extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... param) {
			...
			HttpPost httppost = new HttpPost("http://www.feedbackapp.hostoi.com/check_session.php");
		...
		protected void onPostExecute(String result) {
			if (result.equals("Session ID Not Found")) {
				...
				CharSequence text = "Invalid Session ID! Please submit another to continue.";
				...
				message.putString("SessionID", feedback_form.getText().toString());
				message.putString("Topic", result);
				Intent lookup = new Intent(MainActivity.this, SessionScreen.class);
				lookup.putExtras(message);
				feedback_form.setText("");
